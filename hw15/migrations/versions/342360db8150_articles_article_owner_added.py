...
def upgrade() -> None:
    ...
    op.add_column('articles', sa.Column('owner', postgresql.UUID(as_uuid=True), nullable=True))
    op.create_foreign_key(None, 'articles', 'users', ['owner'], ['uuid'], ondelete='SET NULL')
